...
/**
 * Implements {@link #toByteArray(io.onemfive.did.crypto.PublicKeyPair)} and {@link #toByteArray(io.onemfive.did.crypto.PrivateKeyPair)},
 * and provides methods for AES encryption and decryption.
 *
 * Originally from I2P-Bote.
 */
public abstract class BaseCrypto implements io.onemfive.did.crypto.Crypto {
