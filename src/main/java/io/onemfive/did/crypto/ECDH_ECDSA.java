...
/**
 * Bbase class for ECC (ECDH and ECDSA).
 * <p/>
 ...
 */
public abstract class ECDH_ECDSA extends BaseCrypto {

    private static Logger LOG = Logger.getLogger(ECDH_ECDSA.class.getName());
    ...
    ECDH_ECDSA(String curveName, String sigName, int keyLengthBytes) throws GeneralSecurityException {
        ...
        encryptionKeyPairGenerator.initialize(ecParameterSpec, new SecureRandom());

        signingKeyPairGenerator = KeyPairGenerator.getInstance("ECDSA");
        signingKeyPairGenerator.initialize(ecParameterSpec, new SecureRandom());
    ...
    @Override
    public byte[] toByteArray(io.onemfive.did.crypto.PublicKeyPair keyPair) {
    ...
    @Override
    public byte[] toByteArray(io.onemfive.did.crypto.PrivateKeyPair keyPair) {
        byte[] encrKeyArray = toByteArray(keyPair.encryptionKey);
        byte[] signKeyArray = toByteArray(keyPair.signingKey);
    ...
    @Override
    public io.onemfive.did.crypto.PublicKeyPair createPublicKeyPair(byte[] bytes) throws GeneralSecurityException {
        io.onemfive.did.crypto.PublicKeyPair keyPair = new io.onemfive.did.crypto.PublicKeyPair();
    ...
    @Override
    public io.onemfive.did.crypto.PrivateKeyPair createPrivateKeyPair(byte[] bytes) throws GeneralSecurityException {
        io.onemfive.did.crypto.PrivateKeyPair keyPair = new io.onemfive.did.crypto.PrivateKeyPair();
    ...
    @Override
    public String toBase64(io.onemfive.did.crypto.PublicKeyPair keyPair) throws GeneralSecurityException {
    ...
    @Override
    public String toBase64(io.onemfive.did.crypto.PrivateKeyPair keyPair) throws GeneralSecurityException {
        return toBase64(keyPair.encryptionKey) + toBase64(keyPair.signingKey);
    }

    @Override
    public io.onemfive.did.crypto.PublicKeyPair createPublicKeyPair(String base64) throws GeneralSecurityException {
    ...
    public abstract io.onemfive.did.crypto.PrivateKeyPair createPrivateKeyPair(String base64) throws GeneralSecurityException;
