 ...
 */
public class ElGamal2048_DSA1024 extends BaseCrypto {
    ...
    @Override
    public io.onemfive.did.crypto.PrivateKeyPair createPrivateKeyPair(String base64) throws GeneralSecurityException {
