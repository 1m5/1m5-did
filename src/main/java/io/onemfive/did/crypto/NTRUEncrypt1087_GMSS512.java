...
import de.flexiprovider.pqc.hbc.gmss.*;
 ...
 */
public class NTRUEncrypt1087_GMSS512 extends BaseCrypto {
    ...
    public KeyPair generateSigningKeyPair() throws KeyException, InvalidAlgorithmParameterException, InvalidKeySpecException {
        ...
        gmssKeyPairGenerator.initialize(new GMSSParameterSpec(GMSS_PARAMETERS), new SecureRandom());
    ...
    @Override
    public byte[] sign(byte[] data, PrivateKey key, KeyUpdateHandler keyUpdateHandler) throws GeneralSecurityException, io.onemfive.did.crypto.PasswordException {
